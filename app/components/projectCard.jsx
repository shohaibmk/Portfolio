...
function ProjectCard({ project, onClick }) {
    ...
    return (
        <div onClick={onClick} className="mb-6 border border-gray-300 rounded-lg p-4 hover:shadow-2xl hover:shadow-gray-500/30 transition-all duration-300 h-full flex flex-col hover:cursor-pointer">
            {image && (
                ...
                <div className="mb-3">
                    <div className="flex flex-wrap gap-2">
                        {technologies.map((tech, index) => (
                            <span 
                                key={index} 
                                className="bg-gray-200 text-xs text-gray-800 px-2 py-1 rounded-md"
                            >
                                {tech}
                            </span>
                        ))}
