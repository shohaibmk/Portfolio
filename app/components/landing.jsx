...
const SOCIAL_LINKS = [
  {
    href: "https://res.cloudinary.com/dbqwc4btc/image/upload/v1775831617/Shohaib_Mallick_Resume_luhxdr.pdf",
    label: "Resume",
    bgColor: "bg-black",
...
const ProfileInfo = () => (
  <div className="max-w-2xl lg:mx-32">
    <div id="name" className="space-y-1 md:space-y-2">
      <h1
        className="text-3xl md:text-4xl font-bold flex flex-row items-center gap-2 text-[#fed9bc]"
      ...
      <h2
        className="text-xl md:text-2xl font-bold text-[#fed9bc]/90"
        style={{ fontFamily: "Georgia" }}
      >
        Fullstack Software Engineer
      </h2>
      <h3
        className="text-sm md:text-lg text-[#fed9bc]/80"
        style={{ fontFamily: "Georgia" }}
      >
...
const SkillsSection = () => (
  <div
    className="grid grid-cols-2 sm:grid-cols-3 md:flex md:flex-wrap items-center justify-center gap-2 md:gap-4"
    style={{ fontFamily: "Georgia" }}
  >
    {skills.map((skill) => (
